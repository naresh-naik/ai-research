...
class JacobianLens: # think of this Object as -> A trained microscope
    ...
    def save(self, path: str, *, dtype: torch.dtype = torch.float16) -> None: #dtype=torch.float16 -> 4096x4096 is enormous. Float16-- Cuts storage-> Half without hurting interpretation much.
        ...
        with ActivationRecorder(model.layers, at=record_at) as recorder:
            ...
            """
                                    ...
                                    Record Intermediate Activations
                                                │
                                                ▼
                                Select Requested Layers/Positions
                                                │
                                                ▼
                                (Optional) Jacobian Transport
                                                │
                                                ▼
                                        model.unembed()
                                                │
                                                ▼
                                    Intermediate Vocabulary Logits
                                                │
                                                ▼
                            Compare with Final Layer Predictions
...
"""
                The Complete Workflow of apply()
                        ...
                        ActivationRecorder
                                │
                                ▼
                Residuals from requested layers
                                │
                                ▼
                ...
                transport()         Skip transport
                        ...
                        Vocabulary Logits
                                │
                                ▼
            Compare with Final Layer Logits
                                │
                                ▼
            Return:
            (lens_logits,
