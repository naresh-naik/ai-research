...
# SPDX-License-Identifier: Apache-2.0
            ...
            # """
            # protocol.py -> What kind of model can the lens use?
            # hf.py       -> How do we adapt Hugging Face models?
            # hooks.py    -> Caputre residual streams
            # """

            # # Now we answer:
            # """How do we actually look inside the transformer while it is running?"""
...
class ActivationRecorder:
    ...
    def __init__(
        self,
        blocks: Sequence[nn.Module], # We stored self.layers in hf.py those becomes blocks =[layers0,layer1,....layer31] these are actual Pytorch moduels.
        at: Iterable[int], # ar = [5,18,29] only this layers we are willing to be stored out of 32 total layers not all layers are need to be stored.
        *,
...
"""                 Complete Execution Pipeline So Far.      """
...
"""
                    ...
                    Layer 0         Layer 1         Layer 2
                        ...
                        └───────┬───────┴───────────────┘
                                ▼
                        ActivationRecorder.activations
                                │
                                ▼
                            Dictionary[layer] = residual
                                │
                                ▼
                            Ready for Jacobian
