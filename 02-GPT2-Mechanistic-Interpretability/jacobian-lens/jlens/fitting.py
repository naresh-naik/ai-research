    ...
    with (
        ...
        for pass_idx, dim_start in enumerate(range(0, d_model, dim_batch)):
            ...
            grads = torch.autograd.grad(
                ...
                grad_outputs=cotangent, # It tell PyTorch -> Differentiate only these output dimensions.
...
"""                 The Entire jacobian_for_prompt() Algorithm              """
"""
                                    Prompt
                                        │
                                        ▼
                                    Tokenize
                                        │
                                        ▼
                            Replicate dim_batch Times
                                        │
                                        ▼
                                Single Forward Pass
                                        │
                                        ▼
                        Capture Source & Target Activations
                                        │
                                        ▼
                        For each chunk of output dimensions:
                                        │
                                        ▼
                            Build One-Hot Cotangent Tensor
                                        │
                                        ▼
                            torch.autograd.grad(...)
                                        │
                                        ▼
                        Gradients [B, seq_len, d_model]
                                        │
                                        ▼
                        Average Across Valid Positions
                                        │
                                        ▼
                            Rows of the Jacobian Matrix
                                        │
                                        ▼
                        Fill the Corresponding Matrix Rows
                                        │
                                        ▼
                            Continue Until Matrix Complete
                                        │
                                        ▼
                        Return Per-Prompt Jacobian Jℓ
"""